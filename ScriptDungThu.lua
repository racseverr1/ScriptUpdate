...
if menu == nil then
		...
		if menu[1] == true then TANGKNBTUQUAI() end -- menu 1
		if menu[2] == true then TANGKNBTRUCTIEP() end -- menu 1
...
---------- knb nhan truc tiep từ ruong dã tẩu ---------------
	function TANGKNBTRUCTIEP()
		...
		TANGKNBTRUCTIEP1=gg.multiChoice({
			"🔰Lấy giá trị",	--1
			"🔰Bạc",	--2
			"🔰KNB",	--3
			"❌Exit❌"},nil,"🎉Chọn mục🎉")

		if TANGKNBTRUCTIEP1 == nil then
			else
				if TANGKNBTRUCTIEP1[1] == true then LAYGIATRI1() end -- menu 1
				if TANGKNBTRUCTIEP1[2] == true then BAC1() end -- menu 2
				if TANGKNBTRUCTIEP1[3] == true then KNB1() end -- menu 3	
